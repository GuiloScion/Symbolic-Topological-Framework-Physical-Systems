# -*- coding: utf-8 -*-
"""Phase 1.1: DSL Compiler for Physical Abstractions.ipynb
...
# === Token Types ===
TOKEN_TYPES = [
    ("GREEK_LETTER", r"\alpha|beta|gamma|delta|epsilon|zeta|eta|theta|iota|kappa|lambda|mu|nu|xi|omicron|pi|rho|sigma|tau|upsilon|phi|chi|psi|omega"), #Complete list of Greek letters
...
# === Parser with Expression Support ===
class Parser:
...
# === IR Compiler with Category Theory ===
class CategoricalIR:
    def __init__(self):
